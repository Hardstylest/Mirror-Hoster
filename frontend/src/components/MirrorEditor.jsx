...
import { Save, WifiOff, Trash2, ExternalLink, AlertTriangle, Wand2 } from "lucide-react";

export const MirrorEditor = ({ id, onSuccess }) => {
  const { t } = useI18n();
  ...
  if (loading) return <p className="text-muted-foreground font-mono">{t("common.loading")}</p>;
